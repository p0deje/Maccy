...
// (item count, event kind, numberOfCopies, applied filters) — the single-save
// invariant itself is verified by code review of
// `BackgroundClipboardIngestor.ingest`, since asserting save-count directly
// would require spying on SwiftData.
@MainActor
