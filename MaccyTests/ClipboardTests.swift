...
//    clipboard.onNewCopy({ (_: HistoryItemL) -> Void in
...
//    let item = HistoryItemL(contents: [
//      HistoryItemContentL(type: stringType.rawValue, value: "foo".data(using: .utf8)!),
//      HistoryItemContentL(type: tiffType.rawValue, value: imageData),
//      HistoryItemContentL(type: fileURLType.rawValue, value: "file://foo.bar".data(using: .utf8)!)
//    ])
//    clipboard.copy(item)
...
//    let item = HistoryItemL(contents: [
//      HistoryItemContentL(type: stringType.rawValue, value: "foo".data(using: .utf8)!),
//      HistoryItemContentL(type: rtfType.rawValue,
...
//    let hookExpectation = expectation(description: "Hook is called")
//    clipboard.onNewCopy({ (item: HistoryItemL) -> Void in
//      XCTAssertEqual(
