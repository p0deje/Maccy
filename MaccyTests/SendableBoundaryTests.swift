...
/// Locks the cross-actor `Sendable` boundary — the BS-7 isolation invariant
/// that every type crossing from the off-main ingest actor to the main
/// observer is `Sendable`.
///
